...
// 		e.stopPropagation() // Чтобы клик не сработал на Link
// 		window.Telegram?.WebApp?.HapticFeedback?.impactOccurred('light')
// 		await toggleFavorite(String(product.id))
// 		const favorites = await getFavorites()
// 		setIsFavorite(favorites.includes(String(product.id)))
...
// 			state={{ product }}
// 			className={styles.card_link} // Опционально: для стилизации
// 		>
// 			<div className={styles.card}>
// 				<div style={{ position: 'relative' }}>
// 					<LazyImage
...
// 					<Rating rating={product.rating} />
// 				</div>
// 				<div className={styles.card_button} onClick={handleFavoriteClick}>
// 					<Button w='100%' h='36px'>
// 						{isFavorite ? 'Лайкнуто' : 'Лайкнуть'}
// 					</Button>
// 				</div>
// 			</div>
// 		</Link>
